...
do
	...
	f_dsplyPos  6  20 $faGras$fcRouge'10.'; f_dsplyPos  6  24 $faGras$fcGreen 'Testmem'
	f_dsplyPos  8  20 $faGras$fcRouge'11.'; f_dsplyPos  8  24 $faGras$fcGreen 'Testuse'
    f_dsplyPos 10  20 $faGras$fcRouge'12.'; f_dsplyPos 10  24 $faGras$fcGreen 'Exemple'
	...
	if echo $choix | tr -d [:blank:] | tr -d [:digit:] | grep . &> /dev/null; then
		...
		11)
			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "Testuse"
		;;
